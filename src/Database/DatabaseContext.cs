    ...
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var Studio1 = new GameStudio
            {
                ...
                StudioPicturePath =
                    $"https://sda-3-online-backend-teamwork-ec29.onrender/images/Studios/{studioGuidHelper}/{studioGuidHelper}.png",
            };
            ...
            var Studio2 = new GameStudio
            {
                ...
                StudioPicturePath =
                    $"https://sda-3-online-backend-teamwork-ec29.onrender/images/Studios/{studioGuidHelper}/{studioGuidHelper}.jpg",
            };
            ...
            var Publisher1 = new Publisher
            {
                ...
                PublisherPicturePath =
                    $"https://sda-3-online-backend-teamwork-ec29.onrender/images/Publishers/{publisherGuidHelper}/{publisherGuidHelper}.jpg",
            };
            ...
            var Publisher3 = new Publisher
            {
                ...
                PublisherPicturePath =
                    $"https://sda-3-online-backend-teamwork-ec29.onrender/images/Publishers/{publisherGuidHelper}/{publisherGuidHelper}.png",
            };
            ...
            var VideoGameInfo1 = new VideoGameInfo
            {
                ...
                GamePicturePath =
                    $"https://sda-3-online-backend-teamwork-ec29.onrender/images/Games/{videoGamesInfoGuidHelper}/{videoGamesInfoGuidHelper}.jpg",
            };
            ...
            var VideoGameInfo4 = new VideoGameInfo
            {
                ...
                GamePicturePath =
                    $"https://sda-3-online-backend-teamwork-ec29.onrender/images/Games/{videoGamesInfoGuidHelper}/{videoGamesInfoGuidHelper}.png",
            };
